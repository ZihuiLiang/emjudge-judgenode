...
async fn resource_info() -> Result<(), Error> {
    ...
    let result: emjudge_judgenode::responses::AllInfoResponse =
    ...
    let response = reqwest::Client::new()
        ...
        .unwrap();
    assert_eq!(response.status().as_u16(), 200);
    let result: emjudge_judgenode::responses::DiskInfoResponse =
        serde_json::from_str(&response.text().await.unwrap()).unwrap();
    println!("{:?}", result);
    ...
    let response = reqwest::Client::new()
        ...
        .unwrap();
    assert_eq!(response.status().as_u16(), 200);
    let result: emjudge_judgenode::responses::CpuInfoResponse =
        serde_json::from_str(&response.text().await.unwrap()).unwrap();
    println!("{:?}", result);
    ...
    let response = reqwest::Client::new()
        ...
        .unwrap();
    assert_eq!(response.status().as_u16(), 200);
    let result: emjudge_judgenode::responses::MemInfoResponse =
        serde_json::from_str(&response.text().await.unwrap()).unwrap();
    println!("{:?}", result);
    ...
    let response = reqwest::Client::new()
        ...
        .unwrap();
    assert_eq!(response.status().as_u16(), 200);
    let result: emjudge_judgenode::responses::SysInfoResponse =
        serde_json::from_str(&response.text().await.unwrap()).unwrap();
    println!("{:?}", result);
    Ok(())
}
...
async fn language_info() -> Result<(), Error> {
    ...
    let response = reqwest::Client::new()
        ...
        .unwrap();
    assert_eq!(response.status().as_u16(), 200);
    let result: emjudge_judgenode::responses::LanguagesInfoResponse =
        serde_json::from_str(&response.text().await.unwrap()).unwrap();
    println!("{:?}", result);
    ...
    let response = reqwest::Client::new()
        ...
        .unwrap();
    assert_eq!(response.status().as_u16(), 200);
    let result: emjudge_judgenode::responses::LanguageInfoResponse =
        serde_json::from_str(&response.text().await.unwrap()).unwrap();
    match result {
